...
@dataclass
class MaCPConfig(PeftConfig):
    """
    This is the configuration class to store the configuration of a [`MaCPModel`].
    ...
    init_MaCP_weights: bool | Literal["gaussian", "loftq"] = field(
        default=True,
        metadata={
            "help": (
                "How to initialize the weights of the MaCP layers. Passing True (default) results in the default "
                "initialization from the reference implementation from Microsoft. Passing 'gaussian' results "
                "in Gaussian initialization scaled by the MaCP rank for linear and layers. Setting the initialization "
