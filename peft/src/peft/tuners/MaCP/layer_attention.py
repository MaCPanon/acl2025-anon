    ...
    def apply_attention_weights(self, adapter_name, attention_scores):
        try:
            ...
            if attention_scores.dim() == 3:
                weighted_attention_scores = attention_scores * attention_weights.unsqueeze(0).unsqueeze(2)
            else:
                weighted_attention_scores = attention_scores * attention_weights.unsqueeze(1)
    ...
    def forward(self, x: torch.Tensor, *args: Any, **kwargs: Any) -> torch.Tensor:
        ...
        if self.disable_adapters:
            ...
            for active_adapter in self.active_adapters:
                ...
                result += torch.einsum('ijk,ikl->ijl', x, weighted_delta_w)
